...
class Thread(QThread):
    ...
    def test_image_with_ela(self, image_path, model_path):
        ...
        """
        # loading Model
        self.model_path = "C:\\Users\\Tanmay\\Documents\\Major_Pjct\\DFSpot-Deepfake-Recognition\\img_splice\\sys_models\\ELA_Model.h5"
...
class Test_window(QWidget):
    def __init__(self, parent=None, model_name="ELA", model_path="ELA_Model.h5", flag="here"):
        super().__init__()
    ...
    def init_window(self):
        ...
        self.button.setToolTip(
            "<h5>test image either Forged or Not Forged!<h5>")
        # icon Pic File name
        self.button.setIcon(QtGui.QIcon("repeat-pngrepo-com.png"))
        self.button.setIconSize(QtCore.QSize(15, 15))  # to change icon Size
        ...
        # icon Pic File name
        self.button.setIcon(QtGui.QIcon("cancel-symbol-transparent-9.png"))
        self.button.setIconSize(QtCore.QSize(15, 15))  # to change icon Size
    ...
    def on_click(self):
        if self.file_path == "":
            ...
            msg.setWindowIcon(QtGui.QIcon("Icons/icons8-cbs-512.ico"))
            msg.exec_()
        else:
            ...
            if str(name_2) == "ELA":
                ...
                self.result_window = ResultWindow(
                    label, prob, model_path=self.model_path, model_name=name_2)
