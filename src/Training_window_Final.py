...
class Training_window(QWidget):
    ...
    def init_window(self):
        ...
        self.setWindowIcon(QtGui.QIcon("Icons/icons8-cbs-512.ico")) #icon Pic File name
        ...
        self.button_1.setIcon(QtGui.QIcon("Icons/698831-icon-105-folder-add-512.png")) #icon Pic File name
        ...
        self.button_2.setIcon(QtGui.QIcon("Icons/698831-icon-105-folder-add-512.png"))  # icon Pic File name
        ...
        self.button_3.setIcon(QtGui.QIcon("Icons/create.png"))  # icon Pic File name
        ...
        self.button.setToolTip("<h5>test image either Forged or Not Forged!<h5>")  # Notice using h2 tags From Html
        self.button.setIcon(QtGui.QIcon("Icons/repeat-pngrepo-com.png")) #icon Pic File name
        self.button.setIconSize(QtCore.QSize(15, 15))  # to change icon Size
        ...
        self.button_4.setIcon(QtGui.QIcon("Icons/Rocket-icon-blue.png")) #icon Pic File name
        ...
        self.button.setIcon(QtGui.QIcon("Icons/cancel-symbol-transparent-9.png")) #icon Pic File name
        self.button.setIconSize(QtCore.QSize(15, 15))  # to change icon Size
